...
import { PoModalComponent, PoTableColumn, PoTableComponent, PoModalAction } from '@portinari/portinari-ui';
...
export class GpsModelFillComponent implements AfterViewInit {
    ...
    get canActivate() {
        return (this._canActivate) && (this.model) && (this.model.length > 0);
    }
