...
export class GpsRpwComponent implements OnInit {
  ...
  repeatEachDailyOptions:Array<ThfComboOption> = [];
  repeatEachWeeklyOptions:Array<ThfComboOption> = [];  
  repeatEachMonthlyOptions:Array<ThfComboOption> = [];
  ...
  rpwServerOptions:Array<ThfComboOption> = [];
